/**
 * Encurtador de URL — Entry point principal
 * Vanilla JS com módulos ES e lazy loading de páginas.
 */

import './styles/main.css';

// Lazy loading da página home (gera chunk separado no build)
const loadHome = () => import('./pages/home.js');

// Configuração da URL base da API
// Em produção, substituir por variável de ambiente do Vite
...
// Carregar home module e links ao inicializar a página
document.addEventListener('DOMContentLoaded', async () => {
  // Carrega o módulo home de forma lazy (code splitting)
  await loadHome();
  loadLinks();
});
